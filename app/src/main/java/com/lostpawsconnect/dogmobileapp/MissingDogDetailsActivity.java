...
public class MissingDogDetailsActivity extends AppCompatActivity {

    Dogs dog = null;
    ActivityMissingDogDetailsBinding binding;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMissingDogDetailsBinding.inflate(getLayoutInflater());
    ...
    private void showConfirmationDialog() {
        ...
        builder.setPositiveButton("Yes", (dialog, which) -> {
            ...
            if (!remarks.isEmpty()) {
                ...
                Toast.makeText(MissingDogDetailsActivity.this, "Operation cancelled due to no remarks provided", Toast.LENGTH_SHORT).show();
            }
            dialog.dismiss();
        });
    ...
    private void reportMissing() {
        ...
        FirebaseFirestore.getInstance()
                ...
                .document(dogID).update(
                    ...
                    Toast.makeText(MissingDogDetailsActivity.this, "Reported as found", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(MissingDogDetailsActivity.this, "Failed to report as found, Please Try Again Later", Toast.LENGTH_SHORT).show();
